...
public class RightSwitchDropoffPath extends PathfinderPath{
	...
	public RightSwitchDropoffPath(){
		super.points = new Waypoint[]{
				...
				//new Waypoint(Constants.kRightSwitchFarCorner.x() + Constants.kCubeWidth + Constants.ROBOT_INTAKE_EXTRUSION + Constants.ROBOT_HALF_LENGTH + 1.0, Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH - (23.5/4.0/12.0), Pathfinder.d2r(-45.0)),
				//new Waypoint(Constants.kRightSwitchFarCorner.x() + Constants.kCubeWidth + Constants.ROBOT_INTAKE_EXTRUSION + Constants.ROBOT_HALF_LENGTH + 1.0, Constants.kRightSwitchFarCorner.y() - (Constants.kCubeWidth/2.0) + (23.5/4.0/12.0), Pathfinder.d2r(-135.0)),
